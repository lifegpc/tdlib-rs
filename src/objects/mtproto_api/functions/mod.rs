...
#[derive(Clone, Debug, tdlib_rs_impl::Serialize)]
/// Origin: `set_client_DH_params#f5045f1f nonce:int128 server_nonce:int128 encrypted_data:string = Set_client_DH_params_answer;`
...
impl TypeId for set_client_DH_params {
    fn type_id2() -> u32 {
        0xf5045f1f
    }
}
